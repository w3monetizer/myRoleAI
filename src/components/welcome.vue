<template>
  <div id="welcome">
    ...
    <h1>my things @ AI speed</h1>
    <p><span class="red-text">connect</span> >> <span class="yellow-text">combine</span> >> <span class="blue-text">monetize</span> 24/7 - 3rd gen DNA OS</p>
    <div class="cta">
